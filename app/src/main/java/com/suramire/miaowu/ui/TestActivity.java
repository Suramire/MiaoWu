        ...
        if(TextUtils.isEmpty(url)){
            ...
            onekeyShare.setCallback(new PlatformActionListener() {
                ...
                public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                    Toast.makeText(TestActivity.this, "onComplete", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onError(Platform platform, int i, Throwable throwable) {
                    Toast.makeText(TestActivity.this, "onLoginError", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onCancel(Platform platform, int i) {
                    Toast.makeText(TestActivity.this, "onCancel", Toast.LENGTH_SHORT).show();
                }
            });
